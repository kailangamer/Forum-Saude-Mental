...
<?php
//PEGAR DO BD O QUE ESTÁ NO ATIVO PARA APARECER NO PERFIL PROFISSIONAL:
    $host = "localhost";
    $user = "root";
    $pass = "";
    $db_name = "saudemental";
    ...
    if($row['ativo']=="SIM"){
        if (isset($_POST['submit'])){
            ...
            $sql = "INSERT INTO forum (uname, mensagem, ativo, idSala, data)VALUES ('$un','$m','SIM','2', '$ts')";
            ...
            <form id="myform" action="Group_chatN.php" method="POST" >
