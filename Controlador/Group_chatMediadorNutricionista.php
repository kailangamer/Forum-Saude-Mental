...
?> 
<div>
   <form action="Group_chatRecebeNutricionista.php" method=GET>
...
if($_SESSION["usuario_logado"]==3 && $publicar=="sim"){
    ...
    echo "<h1><center>Esse fórum NÃO será publicado!</center></h1>";
            ...
            $query = "SELECT * FROM forum where idSala=2";
            $run = $con->query($query);
...
$sql = "INSERT INTO forum (uname, mensagem, ativo, idSala, data)VALUES ('$un','$m','NAO','2', '$ts')";
...
<form id="myform" action="Group_chatRecebeNutricionista.php" method="POST" >
