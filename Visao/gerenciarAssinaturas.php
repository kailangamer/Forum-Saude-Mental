...
<html>
    ...
    <body>
        ...
        <h3><center>Gerencia de Assinaturas:<center></h3>
    ...
    echo "<div class='corpo'>";
        echo "<center><table class='av'>";
         ...
         foreach ($array as $array) {
                ...
                echo "<td>". $array['idAssinatura'] . "</td>";
                echo "<td>". $array['nomedt'] . "</td>";
                echo "<td>". $array['valorTotal']      . "</td>";	               
                echo "<td> ";
                ?>
                        <form action="../Controlador/excluirAssinatura.php" method="GET">
                            <input type=hidden name=idAssinatura value= <?php echo $array['idAssinatura'] ;?> >
                            <button>
                ...
                echo  "<td> "; 
                    ?>
                        <form action="../Controlador/alterarAssinatura.php" method="GET">
                                <input type=hidden name=idAssinatura value=<?php echo $array['idAssinatura'];?> >
                                <!-- <input type=hidden name=nome      value=<?php echo $array['nomedt'];?> > -->
                                <button>
