    ...
    <div class="main_header_content">
        ...
        <section class="main_blog">
            <header class="main_blog_header"><BR>
                <h1 class="icon-blog">Gerenciar Perfil:</h1>
            </header>
            <article>
                <a href="listarUsuarios.php"><img src="../img/people.png" width="100px" alt="post" title="Usuario"></a>
               <center> <p>Comum</p></center>
            
            </article>
            <article>
                <a href="listarMediador.php"><img src="../img/iconMed.png" width="100px" alt="post" title="Mediador"></a>
                <center><p>Mediador</p></center>
