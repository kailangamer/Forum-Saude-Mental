...
<head>
    ...
    <title>Formulário Cadastro Mediador</title>
</head>
...
<body>
    ...
    <header class="main_header">
        <div class="main_header_content">
            <a href="../index.php" class="logo">
                <img src="../img/logo.png" alt="Bem vindo ao Fórum Saúde Mental"
    ...
    <div class="container">
    <form action="../Controlador/cadastrarMediador.php" method=POST>
